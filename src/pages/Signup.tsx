      ...
      >
        <div className="glass-effect rounded-2xl p-8 bg-card/95">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold gradient-text-cyan-purple mb-2">Créer un compte</h1>
            <p className="text-muted-foreground">Lance ton premier agent IA en quelques minutes</p>
          </div>
